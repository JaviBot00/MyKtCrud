...
//        lateinit var auxUsername: String
        val mySQLite = SQLiteManager(this@EditActivity)

        var auxUsername = intent.getStringExtra("username").toString()
        if (auxUsername != null) {
        ...
        btnAddImg.setOnClickListener {
            if (ContextCompat.checkSelfPermission(
                    this@EditActivity, Manifest.permission.CAMERA
        ...
        btnSearchImg.setOnClickListener {
            if ((ContextCompat.checkSelfPermission(
                    this@EditActivity, Manifest.permission.WRITE_EXTERNAL_STORAGE
                ) == PackageManager.PERMISSION_DENIED) || (ContextCompat.checkSelfPermission(
                    this@EditActivity, Manifest.permission.READ_EXTERNAL_STORAGE
                ) == PackageManager.PERMISSION_DENIED)
            ) {
                requestPermissions(
                    arrayOf(
        ...
        btnSaveUser.setOnClickListener {
            ...
            if (myBundle.getBoolean("editMode")) {
                ...
                addUser(it)
                val result = Intent(this@EditActivity, MainActivity::class.java)
                setResult(RESULT_OK, result)
                finish()
            }
        }
    ...
    override fun onBackPressed() {
        MaterialAlertDialogBuilder(this@EditActivity).setTitle("Warning")
