...
//        btnSaveUser = findViewById(R.id.btnSaveUser)
        ...
        val mySQLite = SQLiteManager(this@FormActivity)
        ...
        btnAddImg.setOnClickListener {
            if (ContextCompat.checkSelfPermission(
                    this@FormActivity, Manifest.permission.CAMERA
        ...
        btnSearchImg.setOnClickListener {
            if ((ContextCompat.checkSelfPermission(
                    this@FormActivity, Manifest.permission.WRITE_EXTERNAL_STORAGE
                ) == PackageManager.PERMISSION_DENIED) || (ContextCompat.checkSelfPermission(
                    this@FormActivity, Manifest.permission.READ_EXTERNAL_STORAGE
                ) == PackageManager.PERMISSION_DENIED)
            ) {
                requestPermissions(
                    arrayOf(
...
////            if (myBundle != null) {
//            if (intent.getBooleanExtra("editMode")) {
...
//                    val auxBirthDate = textInputBirthday.editText?.text.toString()
...
//
//                    val result = Intent(this@FormActivity, RecyclerviewActivity::class.java)
...
//            } else {
//                addUser(it)
//                val result = Intent(this@FormActivity, MainActivity::class.java)
//                setResult(RESULT_OK, result)
//                finish()
//            }
//        }
...
//        values.put(SQLiteManager.TUsers_USER[0], auxUser.getUserName())
//        values.put(SQLiteManager.TUsers_PASSWORD[0], auxUser.getPassWord())
//        values.put(SQLiteManager.TUsers_BIRTHDATE[0], auxUser.getBirthday())
//        values.put(SQLiteManager.TUsers_IMGPROFILE[0], myImageByteArray)
//        values.put(SQLiteManager.TUsers_ROLE[0], auxUser.getUserRol())
...
//        MenuInflater(this@FormActivity).inflate(R.menu.menu_options, menu)
...
//            )
//            val bottomSheetView: View = LayoutInflater.from(this@FormActivity)
...
//    }
    ...
    override fun onBackPressed() {
        MaterialAlertDialogBuilder(this@FormActivity).setTitle("Warning")
