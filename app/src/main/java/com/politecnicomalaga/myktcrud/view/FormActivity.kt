...
open class FormActivity : AppCompatActivity() {
    ...
    open lateinit var textInputUser: TextInputLayout
    open lateinit var textInputPassword: TextInputLayout
    open lateinit var textInputBirthday: TextInputLayout
    open lateinit var textInputUserGroup: TextInputLayout
    open lateinit var imgProfile: ImageView
    open lateinit var btnAddImg: FloatingActionButton
    open lateinit var btnSearchImg: FloatingActionButton
    open var myImageBitMap: Bitmap? = null
    open var myImageByteArray: ByteArray? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mySQLite = MySQLiteManager(this@FormActivity)
